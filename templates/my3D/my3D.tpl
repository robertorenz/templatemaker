...
#SHEET
  ...
  #TAB('&Meshes')
    ...
    #BUTTON('Meshes'),MULTI(%my3DMesh,%my3DMeshType & ' @ ' & %my3DMeshX & ',' & %my3DMeshY & ',' & %my3DMeshZ),INLINE
      #PROMPT('&Shape:',DROP('Box / Cube[box]|Sphere[sphere]|Cylinder[cylinder]|Cone[cone]|Plane[plane]|Torus[torus]|Torus knot[torusknot]|Tetrahedron[tetra]|Octahedron[octa]|Icosahedron[icosa]|Dodecahedron[dodeca]')),%my3DMeshType,DEFAULT('box')
